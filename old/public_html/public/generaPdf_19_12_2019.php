...
if ($tipologia==privacy){ 
    ...
    $sql = 'select preventivi.id,preventivi.data_preventivo,
            ...
            clienti.indirizzo FROM preventivi , clienti  where preventivi.id = ' .$checkedValue. '  and clienti.id = preventivi.id_cliente';
    ...
    $sql = 'select clienti.nome,clienti.cognome,
            ...
            preventivi.id FROM preventivi , clienti  where preventivi.id = ' .$checkedValue. '  and clienti.id = preventivi.id_cliente';
