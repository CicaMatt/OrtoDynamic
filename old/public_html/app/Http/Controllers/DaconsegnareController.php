...
use App\Models\Daconsegnare;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class DaconsegnareController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'daconsegnare';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Daconsegnare();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'daconsegnare',
	...
	public static function display(  )
	{
		...
		$model  = new Daconsegnare();
		$info = $model::makeInfo('daconsegnare');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('daconsegnare.public.view',$data);			
			}			
		} 
		else {
			...
			return view('daconsegnare.public.index',$data);	
		}
