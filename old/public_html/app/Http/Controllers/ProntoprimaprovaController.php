...
use App\Models\Prontoprimaprova;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ProntoprimaprovaController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'prontoprimaprova';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Prontoprimaprova();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'prontoprimaprova',
	...
	public static function display(  )
	{
		...
		$model  = new Prontoprimaprova();
		$info = $model::makeInfo('prontoprimaprova');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('prontoprimaprova.public.view',$data);			
			}			
		} 
		else {
			...
			return view('prontoprimaprova.public.index',$data);	
		}
