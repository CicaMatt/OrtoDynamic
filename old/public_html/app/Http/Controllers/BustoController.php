...
use App\Models\Busto;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class BustoController extends Controller {
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('busto.public.view',$data);			
			}			
		} 
		else {
			...
			return view('busto.public.index',$data);	
		}
