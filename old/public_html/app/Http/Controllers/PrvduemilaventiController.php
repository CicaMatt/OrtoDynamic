...
use App\Models\Prvduemilaventi;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class PrvduemilaventiController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'prvduemilaventi';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Prvduemilaventi();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'prvduemilaventi',
	...
	public static function display(  )
	{
		...
		$model  = new Prvduemilaventi();
		$info = $model::makeInfo('prvduemilaventi');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('prvduemilaventi.public.view',$data);			
			}			
		} 
		else {
			...
			return view('prvduemilaventi.public.index',$data);	
		}
