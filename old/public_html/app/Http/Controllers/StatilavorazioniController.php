...
use App\Models\Statilavorazioni;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class StatilavorazioniController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'statilavorazioni';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Statilavorazioni();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'statilavorazioni',
	...
	public static function display(  )
	{
		...
		$model  = new Statilavorazioni();
		$info = $model::makeInfo('statilavorazioni');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('statilavorazioni.public.view',$data);			
			}			
		} 
		else {
			...
			return view('statilavorazioni.public.index',$data);	
		}
