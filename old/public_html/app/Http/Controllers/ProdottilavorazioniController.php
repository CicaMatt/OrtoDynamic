...
use App\Models\Prodottilavorazioni;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ProdottilavorazioniController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'prodottilavorazioni';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Prodottilavorazioni();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'prodottilavorazioni',
	...
	public static function display(  )
	{
		...
		$model  = new Prodottilavorazioni();
		$info = $model::makeInfo('prodottilavorazioni');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('prodottilavorazioni.public.view',$data);			
			}			
		} 
		else {
			...
			return view('prodottilavorazioni.public.index',$data);	
		}
