...
use App\Models\Prodottipreventivi;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ProdottipreventiviController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'prodottipreventivi';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Prodottipreventivi();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'prodottipreventivi',
	...
	public static function display(  )
	{
		...
		$model  = new Prodottipreventivi();
		$info = $model::makeInfo('prodottipreventivi');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('prodottipreventivi.public.view',$data);			
			}			
		} 
		else {
			...
			return view('prodottipreventivi.public.index',$data);	
		}
