...
use App\Models\Statocheck;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class StatocheckController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'statocheck';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Statocheck();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'statocheck',
	...
	public static function display(  )
	{
		...
		$model  = new Statocheck();
		$info = $model::makeInfo('statocheck');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('statocheck.public.view',$data);			
			}			
		} 
		else {
			...
			return view('statocheck.public.index',$data);	
		}
