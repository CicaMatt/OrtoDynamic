...
use App\Models\PrvDuemvntd;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class PrvDuemvntdController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'PrvDuemvntd';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new PrvDuemvntd();	
		$this->modelview = new  \App\Models\Prodottipreventivi();
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'PrvDuemvntd',
	...
	public static function display(  )
	{
		...
		$model  = new PrvDuemvntd();
		$info = $model::makeInfo('PrvDuemvntd');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('PrvDuemvntd.public.view',$data);			
			}			
		} 
		else {
			...
			return view('PrvDuemvntd.public.index',$data);	
		}
