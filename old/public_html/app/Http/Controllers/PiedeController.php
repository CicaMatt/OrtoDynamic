...
use App\Models\Piede;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class PiedeController extends Controller {
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('piede.public.view',$data);			
			}			
		} 
		else {
			...
			return view('piede.public.index',$data);	
		}
