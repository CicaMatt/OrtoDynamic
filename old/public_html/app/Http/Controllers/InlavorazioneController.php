...
use App\Models\Inlavorazione;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class InlavorazioneController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'inlavorazione';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Inlavorazione();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'inlavorazione',
	...
	public static function display(  )
	{
		...
		$model  = new Inlavorazione();
		$info = $model::makeInfo('inlavorazione');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('inlavorazione.public.view',$data);			
			}			
		} 
		else {
			...
			return view('inlavorazione.public.index',$data);	
		}
