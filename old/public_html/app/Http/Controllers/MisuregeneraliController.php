...
use App\Models\Misuregenerali;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class MisuregeneraliController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'misuregenerali';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Misuregenerali();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'misuregenerali',
	...
	public static function display(  )
	{
		...
		$model  = new Misuregenerali();
		$info = $model::makeInfo('misuregenerali');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('misuregenerali.public.view',$data);			
			}			
		} 
		else {
			...
			return view('misuregenerali.public.index',$data);	
		}
