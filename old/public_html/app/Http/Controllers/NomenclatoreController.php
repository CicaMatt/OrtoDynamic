...
class NomenclatoreController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'nomenclatore';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Nomenclatore();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'nomenclatore',
	...
	public static function display(  )
	{
		...
		$model  = new Nomenclatore();
		$info = $model::makeInfo('nomenclatore');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('nomenclatore.public.view',$data);			
			}			
		} 
		else {
			...
			return view('nomenclatore.public.index',$data);	
		}
