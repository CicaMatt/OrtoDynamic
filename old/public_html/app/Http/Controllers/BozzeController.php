...
use App\Models\Bozze;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class BozzeController extends Controller {
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('bozze.public.view',$data);			
			}			
		} 
		else {
			...
			return view('bozze.public.index',$data);	
		}
