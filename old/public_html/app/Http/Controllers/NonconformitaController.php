...
class NonconformitaController extends Controller {
	...
	public $module = 'nonconformita';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Nonconformita();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'nonconformita',
	...
	public static function display(  )
	{
		...
		$model  = new Nonconformita();
		$info = $model::makeInfo('nonconformita');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('nonconformita.public.view',$data);			
			}			
		} 
		else {
			...
			return view('nonconformita.public.index',$data);	
		}
