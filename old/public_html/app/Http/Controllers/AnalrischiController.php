...
use App\Models\Analrischi;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class AnalrischiController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'analrischi';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Analrischi();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'analrischi',
	...
	public static function display(  )
	{
		...
		$model  = new Analrischi();
		$info = $model::makeInfo('analrischi');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('analrischi.public.view',$data);			
			}			
		} 
		else {
			...
			return view('analrischi.public.index',$data);	
		}
