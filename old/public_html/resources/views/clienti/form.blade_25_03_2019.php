				...
				<div class="input-group m-b" style="width:150px !important;">
					...
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
						...
						required     class='form-control input-sm ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Cap" class=" control-label col-md-4 text-left"> Cap <span class="asterix"> * </span></label>
										<div class="col-md-6">
			...
			<div class="tab-pane m-t " id="MisureBusto"> 
						     ...
						     class='form-control input-sm ' /> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <?php $spallacci = explode(",",$row['spallacci']); ?>
					  
					<input type='checkbox' name='spallacci[]' value ='1'   class=' minimal-red' 
					@if(in_array('1',$spallacci))checked @endif 
					 /> Si/No  
										 </div> 
										 <div class="col-md-2">
