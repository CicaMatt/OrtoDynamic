...
<div class="page-content row">
	...
	{!! Form::open(array('url'=>'prvduemilaventi?return='.$return, 'class'=>'form-horizontal validated','files' => true )) !!}
	<div class="sbox">
...
<div class="col-md-12">
						<fieldset><legend> PreventiviDuemilaVenti</legend>
						     ...
						     class='form-control input-sm ' /> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='Preventivo' id='Preventivo' value='{{ $row['Preventivo'] }}' 
						     class='form-control input-sm ' /> 
										 </div> 
										 <div class="col-md-2">
						     ...
						     class='form-control input-sm ' /> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='modello' id='modello' value='{{ $row['modello'] }}' 
						     class='form-control input-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='misure' id='misure' value='{{ $row['misure'] }}' 
						     class='form-control input-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group  " >
										<label for="Note Finali" class=" control-label col-md-4 text-left"> Note Finali </label>
										<div class="col-md-6">
										  <input  type='text' name='note_finali' id='note_finali' value='{{ $row['note_finali'] }}' 
						     class='form-control input-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='giorni_scadenza' id='giorni_scadenza' value='{{ $row['giorni_scadenza'] }}' 
						     class='form-control input-sm ' /> 
										 </div> 
										 <div class="col-md-2">
						     ...
						     class='form-control input-sm ' /> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='numero_fattura' id='numero_fattura' value='{{ $row['numero_fattura'] }}' 
						     class='form-control input-sm ' /> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("prvduemilaventi/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
