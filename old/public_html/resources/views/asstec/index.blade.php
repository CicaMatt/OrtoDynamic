	...
	<div class="page-content-wrapper no-margin">
		...
		<div class="sbox">
			...
			<div class="row">
				<div class="col-md-4"> 	
					@if($access['is_add'] ==1)
					<a href="{{ url('asstec/create?return='.$return) }}" class="btn btn-default btn-sm"  
			...
			<div class="table-responsive" style="padding-bottom: 70px;">
 			{!! Form::open(array('url'=>'asstec?'.$return, 'class'=>'form-horizontal m-t' ,'id' =>'SximoTable' )) !!}
							...
							<td>
							 	...
							 	<div class="dropdown">
								  ...
								  <ul class="dropdown-menu">
									...
									<li><a href="{{ url('asstec/'.$row->id.'?return='.$return)}}" class="tips" title="{{ __('core.btn_view') }}"> {{ __('core.btn_view') }} </a></li>
<li><a target="_blank" href="{{ url('assistenzatecnica.php?checkedvalue='.$row->id)}}" class="tips" title="Scheda assistenza tecnica">Scheda assistenza tecnica</a></li>
									@endif
									@if($access['is_edit'] ==1)
									<li><a  href="{{ url('asstec/'.$row->id.'/edit?return='.$return) }}" class="tips" title="{{ __('core.btn_edit') }}"> {{ __('core.btn_edit') }} </a></li>
									@endif
