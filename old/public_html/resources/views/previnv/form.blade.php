...
<div class="page-content row">
	...
	{!! Form::open(array('url'=>'previnv?return='.$return, 'class'=>'form-horizontal validated','files' => true )) !!}
	<div class="sbox">
...
<div class="col-md-12">
						<fieldset><legend> Preventivi Inviati</legend>
						     ...
						     class='form-control input-sm ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Data Prescrizione" class=" control-label col-md-4 text-left"> Data Prescrizione </label>
										<div class="col-md-6">
						     ...
						     class='form-control input-sm ' /> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <textarea name='id_medico' rows='5' id='id_medico' class='form-control input-sm '  
				           >{{ $row['id_medico'] }}</textarea> 
										 </div> 
										 <div class="col-md-2">
				           ...
				           >{{ $row['note'] }}</textarea> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <textarea name='misure_ok' rows='5' id='misure_ok' class='form-control input-sm '  
				           >{{ $row['misure_ok'] }}</textarea> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <textarea name='provvigioni_pagate' rows='5' id='provvigioni_pagate' class='form-control input-sm '  
				           >{{ $row['provvigioni_pagate'] }}</textarea> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("previnv/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
