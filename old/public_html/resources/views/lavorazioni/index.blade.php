	...
	<div class="page-content-wrapper no-margin">
		...
		<div class="sbox">
			...
			<div class="row">
				<div class="col-md-4"> 	
					@if($access['is_add'] ==1)
					<a href="{{ url('lavorazioni/create?return='.$return) }}" class="btn btn-default btn-sm"  
...
<div class="btn-group" >
				        ...
				        <ul class="dropdown-menu">
				            <li><a href="{{ url('lavorazioni') }}?search=data_creazione_lavorazione:like:2022|" class="tips" > Lavorazioni 2022</a></li>
				            <li><a href="{{ url('lavorazioni') }}?search=data_creazione_lavorazione:like:2021|" class="tips" > Lavorazioni 2021</a></li>
							<li><a href="{{ url('lavorazioni') }}?search=data_creazione_lavorazione:like:2020|" class="tips" > Lavorazioni 2020</a></li>
							<li><a href="{{ url('lavorazioni') }}?search=data_creazione_lavorazione:like:2019|" class="tips" > Lavorazioni 2019</a></li>
				        </ul>
				    </div>
			...
			<div class="table-responsive" style="padding-bottom: 70px;">
 			{!! Form::open(array('url'=>'lavorazioni?'.$return, 'class'=>'form-horizontal m-t' ,'id' =>'SximoTable' )) !!}
							...
							<td>
							 	...
							 	<div class="dropdown">
								  ...
								  <ul class="dropdown-menu">
									...
									<li><a href="{{ url('lavorazioni/'.$row->id.'?return='.$return)}}" class="tips" title="{{ __('core.btn_view') }}"> {{ __('core.btn_view') }} </a></li>

<li><a target="_blank" href="{{ url('generacollaudi.php?checkedvalue='.$row->id)}}" class="tips" title="Scheda valutazione rischi e collaudi">Scheda valutazione rischi e collaudi</a></li>

<li><a target="_blank" href="{{ url('inseriscianalisirischi.php?checkedvalue='.$row->id)}}" class="tips" title="inserisci analisi">Inserisci in analisi rischi</a></li>

<li><a target="_blank" href="{{ url('inseriscicontrolli.php?checkedvalue='.$row->id)}}" class="tips" title="inserisci controllo">Inserisci un nuovo controllo</a></li>
									@endif
									@if($access['is_edit'] ==1)
									<li><a  href="{{ url('lavorazioni/'.$row->id.'/edit?return='.$return) }}" class="tips" title="{{ __('core.btn_edit') }}"> {{ __('core.btn_edit') }} </a></li>
									@endif
