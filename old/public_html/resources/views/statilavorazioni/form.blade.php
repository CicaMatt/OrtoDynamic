...
<div class="page-content row">
	...
	{!! Form::open(array('url'=>'statilavorazioni?return='.$return, 'class'=>'form-horizontal validated','files' => true )) !!}
	<div class="sbox">
...
<div class="col-md-12">
						<fieldset><legend> Stati Lavorazioni</legend>
				{!! Form::hidden('id', $row['id']) !!}					
						     ...
						     class='form-control input-sm ' /> 
									  ...
									  <div class="form-group  " >
										<label for="Tabella" class=" control-label col-md-4 text-left"> Tabella </label>
										<div class="col-md-6">
										  <input  type='text' name='tabella' id='tabella' value='{{ $row['tabella'] }}' 
						     class='form-control input-sm ' /> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("statilavorazioni/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
