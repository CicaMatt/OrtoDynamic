...
<div class="page-content row">
	...
	{!! Form::open(array('url'=>'provapdf?return='.$return, 'class'=>'form-horizontal validated','files' => true )) !!}
	<div class="sbox">
...
<div class="col-md-12">
						<fieldset><legend> provapreventivi</legend>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("provapdf/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
