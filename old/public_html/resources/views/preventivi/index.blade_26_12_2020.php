				...
				<div class="col-md-8"> 	
				    ...
				    <div class="btn-group">
				        ...
				        <ul class="dropdown-menu">
							...
							<li><a href="javascript://ajax"  onclick="SximoChangeState('AUTORIZZATO');" class="tips" title="{{ __('core.btn_remove') }}"> Preventivo Autorizzato ASL </a></li>
							...
							<li><a href="javascript://ajax"  onclick="SximoChangeState('FATTURATO');" class="tips" title="{{ __('core.btn_remove') }}"> Ordine Fatturato </a></li>
