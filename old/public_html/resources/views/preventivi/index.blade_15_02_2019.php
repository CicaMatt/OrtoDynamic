				...
				<div class="col-md-8"> 	
				    ...
				    <div class="btn-group">
				        ...
				        <ul class="dropdown-menu">
							...
							<li><a href="javascript://ajax"  onclick="SximoChangeState('ACCETTATTO');" class="tips" title="{{ __('core.btn_remove') }}"> Preventivo Accettato ASL </a></li>
							<li><a href="javascript://ajax"  onclick="SximoChangeState('IN LAVORAZIONE');" class="tips" title="{{ __('core.btn_remove') }}"> Manda in avorazione </a></li>
							<li role="separator" class="divider"></li>
