		...
		<div class="sbox">
			...
			<div class="row">
				<div class="col-md-8"> 	
				    ...
				    <div class="btn-group">
						<button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-menu5"></i> Cambia Stato </button>
				        <ul class="dropdown-menu">
						    <li><a href="javascript://ajax"  onclick="SximoChangeState('IN CORSO');" class="tips" title="{{ __('core.btn_remove') }}"><i class="fa fa-download"></i> In Carico </a></li>	
							<li><a href="javascript://ajax"  onclick="SximoChangeState('ANNULLATO');" class="tips" title="{{ __('core.btn_remove') }}"><i class="fa fa-download"></i> Annulla </a></li>
							<li><a href="javascript://ajax"  onclick="SximoChangeState('ACCETTATTO');" class="tips" title="{{ __('core.btn_remove') }}"><i class="fa fa-download"></i> Accetta </a></li>
							<li><a href="javascript://ajax"  onclick="SximoChangeState('RIFIUTATO');" class="tips" title="{{ __('core.btn_remove') }}"><i class="fa fa-download"></i> Rifiuta </a></li>
				          	<li role="separator" class="divider"></li>
							 <li><a href="javascript://ajax"  onclick="SximoDelete();" class="tips" title="{{ __('core.btn_remove') }}"><i class="fa fa-trash-o"></i>
							Remove Selected </a></li>
				        </ul>
