...
<ul class="nav nav-tabs"><li class="active"><a href="#preventivi" data-toggle="tab">preventivi</a></li>
				...
				{!! Form::hidden('id', $row['id']) !!}					
					...
					$tipologia_preventivo_opt = array( 'Asl' => 'Asl' , 'Inail' => 'Inail' , 'Privato' => 'Privato' , ); ?>
					<select name='tipologia_preventivo' rows='5'   class='select2 '  > 
						...
						?></select> 
				           ...
				           >{{ $row['prescizione_dettagliata_protesi'] }}</textarea> 
									  ...
									  <div class="form-group  " >
										<label for="Data Creazione" class=" control-label col-md-4 text-left"> Data Prescrizione <span class="asterix"> * </span></label>
										<div class="col-md-6">
										  
				<div class="input-group m-b" style="width:150px !important;">
					{!! Form::date('data_creazione', $row['data_creazione'],array('class'=>'form-control input-sm')) !!}
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
									  ...
									  <div class="form-group  " >
										<label for="Data Ricezione" class=" control-label col-md-4 text-left"> Data Preventivo <span class="asterix"> * </span></label>
										<div class="col-md-6">
										  
				<div class="input-group m-b" style="width:150px !important;">
					{!! Form::date('data_preventivo', $row['data_preventivo'],array('class'=>'form-control input-sm')) !!}
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
				</div> 
										 </div> 
										 <div class="col-md-2">
 ...
 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
										<label for="numero_ordine" class=" control-label col-md-4 text-left"> Numero d'ordine </label>
										<div class="col-md-2">
										  <input  type='text' name='numero_ordine' id='numero_ordine' value='{{ $row['numero_ordine'] }}' 
						     class='form-control input-sm ' /> 
										 </div> 
				...
				<div class="input-group m-b" style="width:150px !important;">
					{!! Form::date('data_accettazione', $row['data_accettazione'],array('class'=>'form-control input-sm')) !!}
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
				</div> 
										 </div> 
										 <div class="col-md-2">
				...
				<div class="input-group m-b" style="width:150px !important;">
					{!! Form::date('data_ricezione_autorizzazione', $row['data_ricezione_autorizzazione'],array('class'=>'form-control input-sm')) !!}
					<input type=date name=dataricezione id=dataricezione value='{{ $row['data_ricezione_autorizzazione'] }}' hidden/>
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
				</div> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group  " >
										<label for="misure_ok" class=" control-label col-md-4 text-left"> Provvigioni Pagate </label>
										<div class="col-md-6">
					...
					<input type='radio' name='provvigioni_pagate' value ='Si'  @if($row['provvigioni_pagate'] == 'Si') checked="checked" @endif class='minimal-red' > Si  
									  ...
									  <div class="form-group  " >
										<label for="misure_ok" class=" control-label col-md-4 text-left"> Misure OK </label>
										<div class="col-md-6">
					...
					<input type='radio' name='misure_ok' value ='Si'  @if($row['misure_ok'] == 'Si') checked="checked" @endif class='minimal-red' > Si  
									   ...
									   <div class="form-group  " >
										...
										<div class="col-md-2">
										  <input  type='text' name='modello' required  id='modello' value='{{ $row['modello'] }}' 
						     class='form-control input-sm ' /> 
										 </div> 
										...
										<div class="col-md-2">
										  <input  type='text' name='misure' id='misure'  required  value='{{ $row['misure'] }}' 
						     class='form-control input-sm ' /> 
										 </div> 
									  ...
									  <div class="form-group  " >
										<label for="giorni_scadenza" class=" control-label col-md-4 text-left"> Giorni massima scadenza lavorazione </label>
										<div class="col-md-6">
										  
					<?php $tipologia_giorni_scadenza = explode(',',$row['giorni_scadenza']);
					$tipologia_giorni_scadenza_opt = array( '-SELEZIONA-' => '-SELEZIONA-' , 20 => 20 , '30' => '30' , '60' => '60' , '90' => '90' ); ?>
					<select name='giorni_scadenza' id='giorni_scadenza' rows='5'   class='select2 '  > 
						<?php 
						foreach($tipologia_giorni_scadenza_opt as $key=>$val)
						{
							echo "<option  value ='$key' ".($row['giorni_scadenza'] == $key ? " selected='selected' " : '' ).">$val</option>"; 						
						}						
						?></select> 
										 </div> 
									     ...
									     <div class="form-group  " >
										<label for="massima_scadenza" class=" control-label col-md-4 text-left"> Data massima scadenza  </label>
										<div class="col-md-2">
										 ...
										 <div class="col-md-2">
                                           ...
                                           <div class="form-group  " >
										<label for="Preventivo" class=" control-label col-md-4 text-left"> File allegato </label>
										<div class="col-md-6">
     ...
     <table>
         <tbody>
            <tr class="clone clonedInput">
                ...
                <td>
                <input type="text" id="totale" name="totale" class="form-control input-sm" value="">
                </td>
            </tr>
         </tbody>
     </table> 
	...
	$(document).ready(function() { 
		...
		{  selected_value : '{{ $row["id_medico"] }}' });
			$('input[name="massima_scadenza').prop("readonly", true);
		$('input[name="bulk_importo[]').prop("readonly", true);
		$('input[name="bulk_prezzo[]').prop("readonly", true);
		$('input[name="totale').prop("readonly", true);
		$('.addC').relCopy({limit: 19});
        ...
        var price = $(this).find('input[name="bulk_prezzo[]"]').val();
        price.toFixed(2);
        ...
        $('input[name="totale').val(Math.round(importoTotale * 100) / 100);
    ...
    $('.table-responsive tr').each(function(){
        ...
        $(this).find('input[name="bulk_importo[]"]').val(total.toFixed(2));
        if (!isNaN(total)) {
            importoTotale += total;
        }
        $('input[name="totale').val(Math.round(importoTotale * 100) / 100);
        document.getElementById("totale").value = importoTotale.toFixed(2);
...
$('.table-responsive').on('change', 'select[name="bulk_codice_nomenclatore[]"]', function() {
    var importoTotale = 0;        
    $('.table-responsive tr').each(function(){
        if ($(this).find('select[name="bulk_codice_nomenclatore[]"] option:selected').text()!="") {
        var quantity = parseInt( $(this).find('input[name="bulk_quantita[]"]').val(),10);
       ...
       var nomenclatore =$(this).find('select[name="bulk_codice_nomenclatore[]"] option:selected').text();
       var lunghezza = nomenclatore.length;
       var ris= nomenclatore.trim().split(" ");
       var corretto = ris[ris.length-1];
       $(this).find('input[name="bulk_prezzo[]"]').val(corretto);
       var price = $(this).find('input[name="bulk_prezzo[]"]').val();
        var res = price.trim().split(" ");
        var price2 = res[res.length-1];
        if(!$.isNumeric(price2)){
...
//fix totale
   var values = [];
$("input[name='bulk_importo[]']").each(function() {
...
/*   var values2 = [];
$("input[name='bulk_quantita[]']").each(function() {
...
while(n--){
   ...
   document.getElementById("totale").value = sum.toFixed(2) ;
  
  	//script per scadenza
		$(document).on('change', 'select[name="giorni_scadenza"]', function(){
                 if(document.getElementById('giorni_scadenza').value != '-SELEZIONA-'){
                    var add = parseInt(document.getElementById('giorni_scadenza').value);
              
                    var dataScadenza = new Date(document.getElementById('dataricezione').value);
                  
                    var i = 0;
                    while(i<parseInt(add)){
                    if(dataScadenza.getDay() == 6 || dataScadenza.getDay() == 5){
                        ...
                        var StringaGiorno = String(dataScadenza.getDate());
                        var StringaMese = String(dataScadenza.getMonth()+1);
                        var StringaAnno = String(dataScadenza.getFullYear());
                    
                        document.getElementById("massima_scadenza").value = StringaGiorno +"/"+ StringaMese +"/"+ StringaAnno;
                 }else{
                     document.getElementById("massima_scadenza").value = "In attesa di autorizzazione";
                 }
                 });
 		//fine script
