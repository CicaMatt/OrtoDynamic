		 ...
		 {!! Form::open(array('url'=>'regcontr/savepublic', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
				...
				<div class="input-group m-b" style="width:150px !important;">
					{!! Form::text('data_intervento', $row['data_intervento'],array('class'=>'form-control input-sm date')) !!}
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
				           ...
				           >{{ $row['intervento'] }}</textarea> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <select name='firma_medico' rows='5' id='firma_medico' class='select2 '   ></select> 
										 </div> 
										 <div class="col-md-2">
