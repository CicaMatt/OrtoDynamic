...
<ul class="nav nav-tabs"><li class="active"><a href="#preventivi" data-toggle="tab">preventivi</a></li>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
        ...
        var price = $(this).find('input[name="bulk_importo[]"]').val();
        ...
        if(price2!=null && quantity!=null) {
            if($.isNumeric(sconto)) {
                var subtotal = (price2 * quantity) - ((price2 * quantity)*sconto)/100;
                var total = subtotal;
            } else {
                var subtotal = price2*quantity/quantity;
                var total = subtotal;
            }
        } else {
            total = 0;
