...
<div class="page-content row">
	...
	{!! Form::open(array('url'=>'prevaut?return='.$return, 'class'=>'form-horizontal validated','files' => true )) !!}
	<div class="sbox">
		<div class="sbox-title clearfix">
			...
			<div class="sbox-tools pull-left" >
				...
				<button name="save" class="tips btn btn-sm btn-save"  title="{{ __('core.btn_back') }}" href="{{ url('prevaut') }}" ><i class="fa  fa-paste"></i> {{ __('core.sb_save') }} </button> 
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("prevaut/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
