...
urlpatterns = [
    ...
    path("dashboard-metrics/", QuoteDashboardMetricsView.as_view(), name="dashboard-metrics"),
    ...
    path(
        "<int:pk>/items/<int:item_id>/products/search/",
        QuoteItemProductSearchView.as_view(),
