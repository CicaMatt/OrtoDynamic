...
underlying columns are nullable, `NullToEmptySerializer` renders SQL NULLs as empty
...
class ClientListSerializer(NullToEmptySerializer):
...
class ClientDetailSerializer(NullToEmptySerializer):
...
class ClientOrthopedicSerializer(NullToEmptySerializer):
